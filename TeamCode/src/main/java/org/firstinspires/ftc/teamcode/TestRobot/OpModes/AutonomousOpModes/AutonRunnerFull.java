...
public class AutonRunnerFull {
    ...
    public static void start(LinearOpMode op, Pose2d startPose, Team team) throws InterruptedException {
        ...
        Trajectory wobbleTwoTrajectory1 = roadrunner.trajectoryBuilder(wobbleOneTrajectory2.end())
                .splineToLinearHeading(new Pose2d(34, -2, Math.toRadians(0)), Math.toRadians(0))
                .build();
...
//                .splineToLinearHeading(startPose.plus(new Pose2d(0,6,Math.toRadians(90))), Math.toRadians(0))
//                .build();
//
...
//                .splineTo(new Vector2d(SECOND_WOBBLE_GOAL_PICKUP_POSITION.y, -SECOND_WOBBLE_GOAL_PICKUP_POSITION.x),Math.toRadians(90))
//                .build();
//
